...
from utils.helpers import spawn_tracked
...
class TimedActionsMixin:
    ...
    async def _schedule_unban(self, guild_id, user_id, delay):
        ...
        spawn_tracked(
            self._unban_tasks, key, self._auto_unban(guild_id, user_id, delay)
        )
    ...
    async def _schedule_unslow(self, channel_id, guild_id, delay):
        ...
        spawn_tracked(
            self._slow_tasks, channel_id, self._auto_unslow(channel_id, delay)
        )
