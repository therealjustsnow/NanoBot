...
class Roles(commands.Cog):
    ...
    async def colorgen(
        ...
        # edit_role_positions() sends all roles in one large JSON payload which
        # overflows Discord's upstream proxy buffer (503 "reset reason: overflow").
        # Instead we position each role individually — smaller payloads, reliable.
