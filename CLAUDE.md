...
- `tests/test_activities_commands.py` — `/work`, `/mine` (dig/cave-in/upgrade), `/adventure hunt|explore`, `/rob` guard rails (shield, minimum balances, disabled, cooldown), `/adventure toggle|cooldown|config` admin permission enforcement
