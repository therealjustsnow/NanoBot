...
class CosmeticDef:
    ...
    price: int = 0
    # How the renderer draws this one, in three orthogonal knobs. `texture` is
    # what the surface is made of (clouds/silk/mesh/…), `pattern` is the
    # geometry drawn on top of it (waves/rays/circuit/…), and `style` picks a
    # border treatment (double/glow/…). All plain data: a new look is one
    # string plus one function in utils/profile_card.py, and an empty value
    # means "the original flat look".
    texture: str = ""
    pattern: str = ""
    style: str = ""
...
# A second Gallery batch, chosen for breadth: ukiyo-e, a Song-dynasty scroll, a
# Persian folio, an Egyptian papyrus, a Mesoamerican codex, a Korean screen,
# Art Nouveau, a Morris textile, scientific illustration, a 17th-century star
# chart, and more of the sky. Same rules as the first batch — everything here
# is public domain and credited in assets/profile/CREDITS.md — and seven of
# them are earned rather than sold, hung off whichever activity they suit.
register(
    CosmeticDef(
        key="banner_art_shower",
        name="Sudden Shower over Shin-Ōhashi",
        slot="banner",
        description="Utagawa Hiroshige, 1857.",
        unlock={"kind": "purchase"},
        price=55_000,
        palette=("#465866", "#BCC3B0", "#D7B65C"),
        rarity="epic",
        sort=80,
    ),
    CosmeticDef(
        key="banner_art_thousand_li",
        name="A Thousand Li of Rivers",
        slot="banner",
        description="Wang Ximeng, 1113. Earned by explorers: 400 expeditions.",
        unlock={"kind": "stat", "stat": "explore_count", "value": 400},
        palette=("#4F4F34", "#846F3C", "#2A6893"),
        rarity="legendary",
        sort=81,
    ),
    CosmeticDef(
        key="banner_art_shahnameh",
        name="Shahnameh Folio",
        slot="banner",
        description="Persian manuscript painting, Safavid period.",
        unlock={"kind": "purchase"},
        price=85_000,
        palette=("#343530", "#B19F7F", "#FC9617"),
        rarity="legendary",
        sort=82,
    ),
    CosmeticDef(
        key="banner_art_hunefer",
        name="Book of the Dead",
        slot="banner",
        description="Ancient Egyptian papyrus, 19th Dynasty.",
        unlock={"kind": "purchase"},
        price=65_000,
        palette=("#776146", "#95896A", "#987649"),
        rarity="epic",
        sort=83,
    ),
    CosmeticDef(
        key="banner_art_codex_borgia",
        name="Codex Borgia",
        slot="banner",
        description="Pre-Columbian Mesoamerican manuscript.",
        unlock={"kind": "purchase"},
        price=60_000,
        palette=("#8C5552", "#E2B1B0", "#E43756"),
        rarity="epic",
        sort=84,
    ),
    CosmeticDef(
        key="banner_art_chaekgeori",
        name="Chaekgeori",
        slot="banner",
        description="Korean scholar's-screen painting, Joseon dynasty.",
        unlock={"kind": "purchase"},
        price=55_000,
        palette=("#695D5F", "#D9D1BC", "#C83F35"),
        rarity="epic",
        sort=85,
    ),
    CosmeticDef(
        key="banner_art_mucha",
        name="La Plume",
        slot="banner",
        description="Alphonse Mucha, 1896.",
        unlock={"kind": "purchase"},
        price=90_000,
        palette=("#694227", "#D4A46A", "#DA9235"),
        rarity="legendary",
        sort=86,
    ),
    CosmeticDef(
        key="banner_art_morris",
        name="Strawberry Thief",
        slot="banner",
        description="William Morris, 1883.",
        unlock={"kind": "purchase"},
        price=40_000,
        palette=("#392E45", "#5C5C84", "#AC6C42"),
        rarity="rare",
        sort=87,
    ),
    CosmeticDef(
        key="banner_art_haeckel",
        name="Discomedusae",
        slot="banner",
        description="Ernst Haeckel, 1904. Earned by anglers: a complete dex.",
        unlock={"kind": "stat", "stat": "fish_dex_size", "value": 25},
        palette=("#02411C", "#ED8C73", "#EA422E"),
        rarity="legendary",
        sort=88,
    ),
    CosmeticDef(
        key="banner_art_audubon",
        name="American Flamingo",
        slot="banner",
        description="John James Audubon, 1838. Earned by hunters: 300 hunts.",
        unlock={"kind": "stat", "stat": "hunt_count", "value": 300},
        palette=("#640504", "#FEEACC", "#B31519"),
        rarity="epic",
        sort=89,
    ),
    CosmeticDef(
        key="banner_art_cellarius",
        name="Harmonia Macrocosmica",
        slot="banner",
        description="Andreas Cellarius, 1660. Reach global level 60.",
        unlock={"kind": "global_level", "value": 60},
        palette=("#68584E", "#BBAD8B", "#E0643C"),
        rarity="legendary",
        sort=90,
    ),
    CosmeticDef(
        key="banner_art_jakuchu",
        name="Black Rooster and Nandin",
        slot="banner",
        description="Itō Jakuchū, c. 1760.",
        unlock={"kind": "purchase"},
        price=75_000,
        palette=("#373739", "#776D59", "#C44246"),
        rarity="legendary",
        sort=91,
    ),
    CosmeticDef(
        key="banner_art_yosemite",
        name="Yosemite Valley",
        slot="banner",
        description="Albert Bierstadt, 1868. Earned by miners: 800 digs.",
        unlock={"kind": "stat", "stat": "mine_count", "value": 800},
        palette=("#180603", "#D8B595", "#D09935"),
        rarity="epic",
        sort=92,
    ),
    CosmeticDef(
        key="banner_art_kandinsky",
        name="Composition VII",
        slot="banner",
        description="Wassily Kandinsky, 1913.",
        unlock={"kind": "purchase"},
        price=95_000,
        palette=("#1A101B", "#98896C", "#EFC108"),
        rarity="legendary",
        sort=93,
    ),
    CosmeticDef(
        key="banner_space_saturn",
        name="Across Resplendent Rings",
        slot="banner",
        description="NASA/JPL-Caltech, Cassini. Awarded at prestige 6.",
        unlock={"kind": "prestige", "value": 6},
        palette=("#000000", "#C1A475", "#E9C489"),
        rarity="legendary",
        sort=74,
    ),
    CosmeticDef(
        key="banner_space_andromeda",
        name="Andromeda",
        slot="banner",
        description="NASA/ESA Hubble Space Telescope. Reach global level 90.",
        unlock={"kind": "global_level", "value": 90},
        palette=("#3A3B38", "#717374", "#A5977F"),
        rarity="legendary",
        sort=75,
    ),
    CosmeticDef(
        key="banner_space_mars",
        name="Postcard from Mars",
        slot="banner",
        description="NASA/JPL-Caltech, Curiosity.",
        unlock={"kind": "purchase"},
        price=70_000,
        palette=("#172428", "#5E5A4B", "#FFD858"),
        rarity="epic",
        sort=76,
    ),
    CosmeticDef(
        key="wallet_art_morris",
        name="Morris Billfold",
        slot="wallet",
        description="William Morris, 1883.",
        unlock={"kind": "purchase"},
        price=45_000,
        palette=("#393049", "#605E80", "#B16E42"),
        rarity="rare",
        sort=23,
    ),
    CosmeticDef(
        key="wallet_art_cellarius",
        name="Celestial Ledger",
        slot="wallet",
        description="Andreas Cellarius, 1660.",
        unlock={"kind": "purchase"},
        price=60_000,
        palette=("#66594E", "#B6AAA0", "#DE5F39"),
        rarity="epic",
        sort=24,
    ),
)
